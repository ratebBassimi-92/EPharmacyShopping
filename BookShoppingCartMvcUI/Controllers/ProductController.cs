...
public class ProductController : Controller
{
    ...
    {
        var prodcuts = await _productRepo.GetProducts();
        return View(prodcuts);
    }

    public async Task<IActionResult> AddProdcut()
    {
    ...
    [HttpPost]
    public async Task<IActionResult> AddProdcut(ProductDTO productToAdd)
    {
        var categorySelectList = (await _categoryRepo.GetCategorys()).Select(category => new SelectListItem
        {
            Text = category.CategoryName,
        ...
        try
        {
            ...
            TempData["successMessage"] = "Prodcut is added successfully";
            return RedirectToAction(nameof(AddProdcut));
        }
