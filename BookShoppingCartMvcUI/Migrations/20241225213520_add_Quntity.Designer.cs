...
namespace BookShoppingCartMvcUI.Migrations
{
    ...
    [Migration("20241225213520_add_Quntity")]
    partial class add_Quntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShoppingCartMvcUI.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShoppingCartMvcUI.Models.CartDetail", b =>
                {
                    b.HasOne("BookShoppingCartMvcUI.Models.Product", "Product")
            ...
            modelBuilder.Entity("BookShoppingCartMvcUI.Models.Stock", b =>
                {
                    b.HasOne("BookShoppingCartMvcUI.Models.Product", "Product")
                        .WithOne("Stock")
                        .HasForeignKey("BookShoppingCartMvcUI.Models.Stock", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
